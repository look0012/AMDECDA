function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,predictions_f1] = elm(DataSet,TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
